...
class Doctor:        
    ...
    def add_details(self):
        ...
        if x=="Add Diagnosis..." or len(x)==0 and y=="Enter Prescription..." or len(y)==0:
            messagebox.showerror("Error","Please enter a valid diagnosis and prescription",parent=self.doctor)
