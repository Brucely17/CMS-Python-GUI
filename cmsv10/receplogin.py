...
class LoginPage:
    ...
    def __init__(self, window):
        ...
        self.window.title('Receptionist Login Page')

        # ========================================================================
        # ============================background image============================
        # ========================================================================
        self.bg_frame = Image.open('./images/recepadmin.png')
        ...
        def signinf():
            ...
            with open("USER DATA FA.csv",'r') as f :
                ...
                for i in range(len(data)-1):
                    if data[i][2]==uncheck and data[i][3]==pwdcheck and data[i][1].lower()=="receptionist":
                        flag=1
